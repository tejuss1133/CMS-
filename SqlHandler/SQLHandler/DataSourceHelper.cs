                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    if (!objPropertyType.IsEquivalentTo(dr[i].GetType()))
                                    {
                                        ...
                                        else if (objPropertyType.FullName.Contains("System.Nullable") && dr[i].GetType().FullName == "System.DateTime")
                                        {
                                            string colValue = dr.GetValue(i).ToString();
                                            DateTime? dateTime = !string.IsNullOrEmpty(colValue) ? DateTime.Parse(colValue) : null;
                                            objPropertyInfo.SetValue(objObject, dateTime, null);
                                        }
                                        else
                                        {
